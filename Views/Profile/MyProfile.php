...
function Begin($Request){
	...
	$Result = (new ModelExcutionEngine())->FetchAllRows('SELECT * FROM posts WHERE user_email = ? AND deleted = ? ORDER BY id DESC',
		array( (new HashingEngine())->Hash_POSTS($_SESSION['Email']), '0'));
