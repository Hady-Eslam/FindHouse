...
function Messages_Print_Messages($Message){
	...
	?>
		<div style="border-bottom-width: 1px;border-bottom-color: #454545;border-bottom-style: solid;" id="<?php echo $GLOBALS['MESSAGE_ID']; ?>">
   			...
   			<p style="display: inline-block;vertical-align: top; padding-left: 2%;padding-right: 2%;text-overflow: ellipsis;overflow: hidden;font-size: 17px;white-space: nowrap;width: 20%"><?php echo $GLOBALS['Message_Email']; ?>: </p>
