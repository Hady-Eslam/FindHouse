...
function Homes_Category(){
	return '
		<div class="col-12 col-md-6 col-lg-4" id="Post_1_'.$GLOBALS['ADD_ID'].'">
            <div class="single-property-area wow fadeInUp" data-wow-delay="200ms">
                ...
                <div class="information-area mb-80 wow fadeInUp" data-wow-delay="200ms">
	                ...
	                <!-- Content -->
	                <a class="btn rehomes-btn mt-10" style="width: 40%" onclick="DeletePost('
	                	.$GLOBALS['ADD_ID'].', 1)">Delete</a>

	                <a class="btn rehomes-btn mt-10" style="width: 40%" href="'
	                	.EditPost.'Homes/'.$GLOBALS['ADD_ID'].'">Edit</a>
	            </div>
...
function Mobiles_Category(){
	return '
		<div class="col-12 col-md-6 col-lg-4" id="Post_2_'.$GLOBALS['ADD_ID'].'">
            <div class="single-property-area wow fadeInUp" data-wow-delay="200ms">
                <!-- Property Thumb -->
                <div class="property-thumb">
                ...
                <div class="information-area mb-80 wow fadeInUp" data-wow-delay="200ms">
	                ...
	                <!-- Content -->
	                <a class="btn rehomes-btn mt-10" style="width: 40%" onclick="DeletePost('
	                	.$GLOBALS['ADD_ID'].', 2)">Delete</a>

	                <a class="btn rehomes-btn mt-10" style="width: 40%" href="'
	                	.EditPost.'Mobiles/'.$GLOBALS['ADD_ID'].'">Edit</a>
	            </div>
...
function Cars_Category(){
	return '
		<div class="col-12 col-md-6 col-lg-4" id="Post_3_'.$GLOBALS['ADD_ID'].'">
            <div class="single-property-area wow fadeInUp" data-wow-delay="200ms">
                <!-- Property Thumb -->
                <div class="property-thumb">
                ...
                <div class="information-area mb-80 wow fadeInUp" data-wow-delay="200ms">
	                ...
	                <!-- Content -->
	                <a class="btn rehomes-btn mt-10" style="width: 40%" onclick="DeletePost('
	                	.$GLOBALS['ADD_ID'].', 3)">Delete</a>

	                <a class="btn rehomes-btn mt-10" style="width: 40%" href="'
	                	.EditPost.'Cars/'.$GLOBALS['ADD_ID'].'">Edit</a>
	            </div>
...
function Elc_Category(){
	return '
		<div class="col-12 col-md-6 col-lg-4" id="Post_4_'.$GLOBALS['ADD_ID'].'">
            <div class="single-property-area wow fadeInUp" data-wow-delay="200ms">
                <!-- Property Thumb -->
                <div class="property-thumb">
                ...
                <div class="information-area mb-80 wow fadeInUp" data-wow-delay="200ms">
	                ...
	                <!-- Content -->
	                <a class="btn rehomes-btn mt-10" style="width: 40%" onclick="DeletePost('
	                	.$GLOBALS['ADD_ID'].', 4)">Delete</a>

	                <a class="btn rehomes-btn mt-10" style="width: 40%" href="'
	                	.EditPost.'Elc/'.$GLOBALS['ADD_ID'].'">Edit</a>
	            </div>
...
function Lux_Category(){
	return '
		<div class="col-12 col-md-6 col-lg-4" id="Post_5_'.$GLOBALS['ADD_ID'].'">
            <div class="single-property-area wow fadeInUp" data-wow-delay="200ms">
                <!-- Property Thumb -->
                <div class="property-thumb">
                ...
                <div class="information-area mb-80 wow fadeInUp" data-wow-delay="200ms">
	                ...
	                <!-- Content -->
	                <a class="btn rehomes-btn mt-10" style="width: 40%" onclick="DeletePost('
	                	.$GLOBALS['ADD_ID'].', 5)">Delete</a>

	                <a class="btn rehomes-btn mt-10" style="width: 40%" href="'
	                	.EditPost.'Lux/'.$GLOBALS['ADD_ID'].'">Edit</a>
	            </div>
...
function Fashion_Category(){
	return '
		<div class="col-12 col-md-6 col-lg-4" id="Post_6_'.$GLOBALS['ADD_ID'].'">
            <div class="single-property-area wow fadeInUp" data-wow-delay="200ms">
                <!-- Property Thumb -->
                <div class="property-thumb">
                ...
                <div class="information-area mb-80 wow fadeInUp" data-wow-delay="200ms">
	                ...
	                <!-- Content -->
	                <a class="btn rehomes-btn mt-10" style="width: 40%" onclick="DeletePost('
	                	.$GLOBALS['ADD_ID'].', 6)">Delete</a>

	                <a class="btn rehomes-btn mt-10" style="width: 40%" href="'
	                	.EditPost.'Fashion/'.$GLOBALS['ADD_ID'].'">Edit</a>
	            </div>
...
function Eat_Category(){
	return '
		<div class="col-12 col-md-6 col-lg-4" id="Post_7_'.$GLOBALS['ADD_ID'].'">
            <div class="single-property-area wow fadeInUp" data-wow-delay="200ms">
                <!-- Property Thumb -->
                <div class="property-thumb">
                ...
                <div class="information-area mb-80 wow fadeInUp" data-wow-delay="200ms">
	                ...
	                <!-- Content -->
	                <a class="btn rehomes-btn mt-10" style="width: 40%" onclick="DeletePost('
	                	.$GLOBALS['ADD_ID'].', 7)">Delete</a>

	                <a class="btn rehomes-btn mt-10" style="width: 40%" href="'
	                	.EditPost.'Eat/'.$GLOBALS['ADD_ID'].'">Edit</a>
	            </div>
...
function Doc_Category(){
	return '
		<div class="col-12 col-md-6 col-lg-4" id="Post_8_'.$GLOBALS['ADD_ID'].'">
            <div class="single-property-area wow fadeInUp" data-wow-delay="200ms">
                <!-- Property Thumb -->
                <div class="property-thumb">
                ...
                <div class="information-area mb-80 wow fadeInUp" data-wow-delay="200ms">
	                ...
	                <!-- Content -->
	                <a class="btn rehomes-btn mt-10" style="width: 40%" onclick="DeletePost('
	                	.$GLOBALS['ADD_ID'].', 8)">Delete</a>

	                <a class="btn rehomes-btn mt-10" style="width: 40%" href="'
	                	.EditPost.'Doc/'.$GLOBALS['ADD_ID'].'">Edit</a>
	            </div>
...
function Ant_Category(){
	return '
		<div class="col-12 col-md-6 col-lg-4" id="Post_9_'.$GLOBALS['ADD_ID'].'">
            <div class="single-property-area wow fadeInUp" data-wow-delay="200ms">
                <!-- Property Thumb -->
                <div class="property-thumb">
                ...
                <div class="information-area mb-80 wow fadeInUp" data-wow-delay="200ms">
	                ...
	                <!-- Content -->
	                <a class="btn rehomes-btn mt-10" style="width: 40%" onclick="DeletePost('
	                	.$GLOBALS['ADD_ID'].', 9)">Delete</a>

	                <a class="btn rehomes-btn mt-10" style="width: 40%" href="'
	                	.EditPost.'Ant/'.$GLOBALS['ADD_ID'].'">Edit</a>
	            </div>
